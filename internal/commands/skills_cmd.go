...
func cmdSkillsList() error {
	items := []map[string]string{
		...
		{"name": "luma-core-topic-discovery", "layer": "core", "description": "Build topic search matrix and mine canonical signals"},
		{"name": "luma-core-topic-selection", "layer": "core", "description": "Select one topic locally from profile, history, and signals"},
		{"name": "luma-core-longform-plan", "layer": "core", "description": "Draft or revise a longform content plan"},
		{"name": "luma-core-script-writing", "layer": "core", "description": "Draft or revise a spoken script and review payload"},
		...
		{"name": "luma-content-script", "layer": "workflow", "description": "Glue workflow for original profile-to-script production"},
