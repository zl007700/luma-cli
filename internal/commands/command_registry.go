...
func commandRegistry() map[string]commandSpec {
	specs := []commandSpec{
		...
		{Name: "avatar-persona", Description: "Avatar persona management", Handler: cmdAvatarPersona},
		...
		{Name: "url-read", Description: "Read URL content through cloud Jina Reader", Handler: cmdURLRead},
