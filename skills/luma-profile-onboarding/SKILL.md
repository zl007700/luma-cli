...
metadata:
  relatedSkills: ["luma-shared", "luma-content-script", "luma-workflow-original-ip-talk"]
---
...
- suggested next skill: `luma-content-script` for a script, or `luma-workflow-original-ip-talk` for a full PPT + digital-human video
