	...
	return []common.Shortcut{
		{
			...
			Flags: []common.Flag{
				...
				{Name: "output", Description: "Output video path.", Default: "bgm_video.mp4"},
			},
		...
		},
		{
			...
			Flags: []common.Flag{
				...
				{Name: "output", Description: "Output image path.", Default: "cover_frame.png"},
			},
		...
		},
		{
			...
			Flags: []common.Flag{
				...
				{Name: "output", Description: "Output cover image path.", Default: "title_cover.jpg"},
			},
